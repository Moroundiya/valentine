...
export default function WheelSpinner() {
	...
	// Build conic gradient dynamically so slices & colors always match
	...
	return (
		<div className="flex flex-col items-center gap-6 p-6 sm:p-10 overflow-hidden relative bg-red-500 w-full">
			{/* Arrow */}
			...
			{/* Wheel */}
			<div
				className="relative aspect-square w-96 rounded-full border-10 border-[#A02956]
				...
				{items.map((item, index) => {
					...
					return (
						<div
							...
							<div
								className="absolute top-[20%] left-1/2 -translate-x-1/2 ms-13 w-full text-center -rotate-[90deg] text-sm md:text-base font-semibold"
